...
import header1 from "../../assets/airport.gif";
import header2 from "../../assets/city-bus.gif";
import header3 from "../../assets/train.gif";
import header4 from "../../assets/Yacht.gif";
  ...
  return (
    ...
    >
      ...
      {[
        ...
        <div
          key={i}
          className="md:h-[70vh] grid grid-cols-1 md:grid-cols-6 items-center"
        >
          {/* Content */}
          ...
          {/* Image */}
          <div className="col-span-3 md:col-span-2 h-full hidden md:block w-full">
